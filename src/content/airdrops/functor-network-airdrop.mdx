...
image: "https://res.cloudinary.com/duscymcfc/image/upload/f_auto,q_auto/v1/AirdropWatch/projects/functor-network"  # Replace with actual image URL if available
status: "active"
difficulty: "medium"
